...
public class FXMLDocumentController implements Initializable {
    ...
    private void buildMap(File imgFile) {
        ...
        System.out.println("Mapa cargado: " + imgFile.getPath() + " (W: " + W + ", H: " + H + ")");
         
        zoom_slider.setValue(1.0); // Reiniciamos el zoom al cargar un nuevo mapa
        System.out.println("Zoom reiniciado a 100 %");
    }
